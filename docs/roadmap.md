...
- **Milestone**: 02 - Events: Event Creation & Publication
  ...
  - Detail file: `docs/milestones/milestone-02.md` (create when M02 planning starts)
...
| 02 - Events: Event Creation & Publication | Event lifecycle and publication flow are operational | In planning |
