...
The Events module supports basic venue management and manifest template management end-to-end, with persistence in the `events` schema and retrieval APIs for both capabilities.
...
This milestone should be planned primarily around user-meaningful capabilities. Cross-cutting technical work should stay inside slices unless it unlocks multiple capabilities across the milestone.

## In Scope

- [x] Venue management
- [x] Manifest template management
- [x] Supporting technical work required to enable both capabilities
