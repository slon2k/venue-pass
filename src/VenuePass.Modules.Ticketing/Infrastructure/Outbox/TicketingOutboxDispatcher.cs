...
namespace VenuePass.Modules.Ticketing.Infrastructure.Outbox;

internal sealed class TicketingOutboxDispatcher(
    IServiceProvider serviceProvider,
    TimeProvider timeProvider,
    ILogger<TicketingOutboxDispatcher> logger) : BackgroundService
{
    ...
    {
        logger.LogInformation("Ticketing outbox dispatcher started.");
        ...
        logger.LogInformation("Ticketing outbox dispatcher stopped.");
    }
    ...
    internal async Task DispatchBatchAsync(CancellationToken ct)
    {
        ...
        {
            var db = queryScope.ServiceProvider.GetRequiredService<TicketingDbContext>();
