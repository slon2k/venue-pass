...
public sealed class GeneralAdmissionArea : Entity<GeneralAdmissionAreaId>
{
    ...
    internal static GeneralAdmissionArea CreateFrom(TemplateModel.GeneralAdmissionArea templateArea)
    {
        ArgumentNullException.ThrowIfNull(templateArea);

        return Create(
            new GeneralAdmissionAreaName(templateArea.Name),
            new GeneralAdmissionCapacity(templateArea.Capacity));
    }
}
