...
internal sealed class EventsOutboxDispatcher(
    IServiceProvider serviceProvider,
    TimeProvider timeProvider,
    ILogger<EventsOutboxDispatcher> logger) : BackgroundService
{
    ...
    {
        logger.LogInformation("Events outbox dispatcher started.");
        ...
        logger.LogInformation("Events outbox dispatcher stopped.");
    }
    ...
    internal async Task DispatchBatchAsync(CancellationToken ct)
    {
        ...
        {
            var db = queryScope.ServiceProvider.GetRequiredService<EventsDbContext>();
